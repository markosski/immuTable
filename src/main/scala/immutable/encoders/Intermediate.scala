...
//case object Intermediate extends Encoder with Iterable[(Int, _)] {
//    def iterator = new IntermediateIterator()
//
//    class IntermediateIterator(col: Column, seek: Int=0) extends SeekableIterator[(Int, _)] {
...
//                col match {
//                    case x: VarCharColumn => Conversions.bytesToInt(bytes)
